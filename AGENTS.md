# AGENTS.md - 武侠游戏 (Wuxia RPG) 架构准则

此文件定义了本项目的核心架构与运转逻辑，是 Codex 的“指南针”。
...
### 成长与物品
- **martial-arts-skill**: 定义武学秘籍与内功心法体系。
- **item-skill**: 管理道具、传说武器锻造（不含耐久度系统）。
...
## 4. 维护规范
- **业务细节下沉**: 具体的武学数值、NPC 好感度逻辑、空间节点详情必须保留在各自 Skill 的文档中，`AGENTS.md` 不记录具体数值。
